...
## 연결된 페이지
- [Anthropic Model Welfare — AI의 도덕적 지위라는 열린 문제](anthropic-model-welfare.md) · [Emotion Concepts and their Function in a Large Language Model](anthropic-emotions-2026.md) — AI Welfare 연구 클러스터 자매(본 논문=도덕지위 정초 Long/Sebo / Anthropic welfare 실무 프로그램 / 감정 유사 메커니즘 행동영향)
