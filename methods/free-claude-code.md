...
| 슈퍼센트 지원 작업 | **중립** | Claude/Gemini 분업 구조로 이미 비용 관리. 프록시 불필요. |
...
내 Claude/Gemini 분업 규칙(CLAUDE.md)과 같은 철학. "호출 자체가 비싸다, 호출을 줄여라".
...
- professional — Claude/Gemini 분업 맥락에서 추가 백엔드 고려 대상
