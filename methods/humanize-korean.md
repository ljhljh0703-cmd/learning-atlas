...
> AI가 쓴 한글 글의 "티"(번역투·AI 관용구·기계적 구조·이모지 남용)를 **10대 카테고리 60+ 패턴**으로 심각도(S1/S2/S3) 탐지 → 내용 불변·수술적 윤문해 중립적 자연 한국어로. 작가 파이프라인의 **1차(de-AI 중립화)** → ~~juhyeong-voice~~(폐기 2026-07-30) **2차(개성화)** 전 단계.
...
- ✅ **~~juhyeong-voice~~(폐기 2026-07-30) SKILL 연결** — §3 절차 앞 "0차: humanize-korean 1차 먼저(역순 금지)" 추가.
...
## 연결된 페이지
- ~~juhyeong-voice~~(폐기 2026-07-30)(2차 개성화 — humanize 1차 뒤 / 역순 금지) · [Academic Research Skills (ARS) — 작가 거버넌스·검증 철학의 학술논문 도메인 쌍둥이](academic-research-skills.md)(영어권 Writing Quality Check 한글 대응) · cold-verify-before-adopt(humanizer=품질 도구로 검증)
