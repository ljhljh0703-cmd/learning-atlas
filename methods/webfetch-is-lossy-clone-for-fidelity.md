...
- [검증자의 주장도 환각이다 — 강한 주장은 1차 출처로 재-Gate](verifier-claims-need-regate.md) — 학습 충실성 3종의 세 번째(검증자 주장도 1차 출처로 재-Gate). 본 원칙=입력 *충실*, verifier=검증 *신뢰*, research-thoroughly=흡수 *깊이*
